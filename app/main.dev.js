...
// we attach the redux devtools directly to the body so that it doesn't
// interfere with app styling in any way, similar to how we would set up a popup
/*
...
let devtools = (
  <DevTools
     store={store}
     monitor={DiffLogMonitor}
     visibleOnLoad={false}
     shortcut='ctrl+d'
  />
)

DOM.render(devtools, devtools_wrapper)
